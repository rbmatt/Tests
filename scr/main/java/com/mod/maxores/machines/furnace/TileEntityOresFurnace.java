...
import static com.mod.maxores.machines.furnace.OresFurnace.FACING;
...
public class TileEntityOresFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    private static final int[] SLOTS_TOP = new int[]{0};
    private static final int[] SLOTS_BOTTOM = new int[]{2, 1};
    private static final int[] SLOTS_SIDES = new int[]{1};
    public static boolean keepInventory;
    private int OresFurnace = 0;
    ...
    public static void registerFixesFurnace(DataFixer fixer) {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityOresFurnace.class, new String[]{"Items"}));
    }
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.ores_furnace";
    }
        ...
        if (!this.world.isRemote)
		{
            ...
            if (flag != this.isBurning())
            {
                ...
                if (flag1) {
                    ...
                    {
                        case 0:
                            world.setBlockState(pos, ModBlocks.ORES_FURNACE_ACTIVE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
                            world.setBlockState(pos, ModBlocks.ORES_FURNACE_ACTIVE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
                            break;
                    }
                } else {
                    ...
                    {
                        case 0:
                            world.setBlockState(pos, ModBlocks.ORES_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
                            world.setBlockState(pos, ModBlocks.ORES_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
                            break;
                    }
                }
    ...
    private boolean canSmelt()
	{
        if (((ItemStack) this.furnaceItemStacks.get(0)).isEmpty())
		{
            ...
            ItemStack itemstack = OresFurnaceRecipes.instance().getSmeltingResult(this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
	{
        if (this.canSmelt())
		{
            ...
            ItemStack itemstack1 = OresFurnaceRecipes.instance().getSmeltingResult(itemstack);
    ...
    {
        return "mo:ores_furnace";
    }

    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        return new ContainerOresFurnace(playerInventory, this);
    }
